...
- **Access** ["The Practice of Statistics in the Life Sciences"](https://ebookcentral.proquest.com/lib/berkeley-ebooks/detail.action?docID=6643934) **online**

**Access instructions** 
The library’s digital book system offers two ways to access the material: you can either read online or download chapters as PDFs. Please note that there is an access limit applies to the online reading option, so if you try to read online you may need to wait until access becomes available. To avoid this issue, we recommend downloading the chapters or subsections you need for the week from the link provided above. Once downloaded, you can read the material anytime
